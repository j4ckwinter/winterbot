...
- [x] **DS-07**: Site deploys to Vercel from git push with zero manual steps

### Navigation

- [x] **NAV-01**: A persistent navigation element provides anchor links to all six sections (Hero, About, Experience, Projects, Skills, Contact)
- [x] **NAV-02**: Navigation uses a journey metaphor — a visual path/progress indicator that shows the user's current position through the sections as they scroll

### Hero

- [x] **HERO-01**: Hero section displays a trainer card / identity card with: name, title/class, years of experience (framed as level), and location/region
- [x] **HERO-02**: Trainer card includes a profile portrait area (photo or styled avatar placeholder)
- [x] **HERO-03**: Hero section includes a headline and short intro text outside the card
- [x] **HERO-04**: Hero section includes primary CTA links (view projects, contact)

### About

- [x] **ABOUT-01**: About section presents the user's background framed as a character origin/backstory in the adventure aesthetic
- [x] **ABOUT-02**: About section uses the established Panel primitive and design system tokens
